...
extern int  BZ2_bzDecompressInit(bz_stream *strm, int verbosity, int __small);
...
#define VPrintf0(zf) 1
#define VPrintf1(zf,za1) 1
#define VPrintf2(zf,za1,za2) 1
#define VPrintf3(zf,za1,za2,za3) 1 
#define VPrintf4(zf,za1,za2,za3,za4) 1
#define VPrintf5(zf,za1,za2,za3,za4,za5) 1
                ...
                Int32*  budget )
{
   ...
   /*--
      Now ftab contains the first loc of every __small bucket.
      Calculate the running order, from __smallest to largest
      big bucket.
   --*/
   for (i = 0; i <= 255; i++) {
      bigDone     [i] = False;
   ...
   for (i = 0; i <= 255; i++) {
      ...
      /*--
         ...
         mainQSort3 to sort the __small buckets [ss, j], but
      ...
      /*--
         ...
         any unsorted __small buckets [ss, j], for j != ss.  
         Hopefully previous pointer-scanning phases have already
         completed many of the __small buckets [ss, j], so
      ...
      /*--
         ...
         sorted order for __small buckets [t, ss] for all t,
                       ...
                       int        __small )
{
   ...
   if (strm == NULL) return BZ_PARAM_ERROR;
   if (__small != 0 && __small != 1) return BZ_PARAM_ERROR;
   ...
   strm->total_out_lo32     = 0;
   strm->total_out_hi32     = 0;
   s->__smallDecompress       = (Bool)__small;
   s->ll4                   = NULL;
   s->ll16                  = NULL;
   s->tt                    = NULL;
   s->currBlockNo           = 0;
                             ...
                             int           verbosity )
{
   ...
   strm.bzfree = NULL;
   strm.opaque = NULL;
   ret = BZ2_bzDecompressInit ( &strm, verbosity, __small );
   if (ret != BZ_OK) return ret;
