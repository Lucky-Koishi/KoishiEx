...
ExRabbit文件夹是黑猫版的源代码，目前更新至黑猫.1.4。
ExParrot文件姐是白猫版的源代码，目前更新至白猫内测版。
...
The folder "ExRabbit" is the source code of the BlackCat version, which has currently updated to BlackCat.1.4.
The folder "ExParrot" is the source code of the WhiteCat version, which has currently updated to WhiteCat Alpha.
