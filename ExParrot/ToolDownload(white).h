...
public:
	...
	DeclareThreadFunc(LoadServerList, PVOID);
	DeclareThreadFunc(LoadFileList, CString);
	DeclareThreadFunc(DownloadListFile, PVOID);
	DeclareThreadFunc(DownloadFile, PVOID);
public:
